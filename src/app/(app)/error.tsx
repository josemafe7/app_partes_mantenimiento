...
/*
 * Fallo inesperado al preparar una pantalla (por ejemplo, la base de datos no
 * responde). Sin este archivo Next muestra su página genérica, en inglés.
 * Mantiene la navegación, porque el layout de la aplicación sigue en pie.
 */
